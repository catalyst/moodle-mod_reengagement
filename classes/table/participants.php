...
require_once($CFG->dirroot . '/mod/reengagement/compat.php');
...
class participants extends \table_sql {
    ...
    public function col_fullname($data) {
        ...
        return $OUTPUT->user_picture($data, array('size' => 35, 'courseid' => $this->course->id, 'includefullname' => true)) .fullname($data);
    }
